...
let tests_tokenize = "test suite for tokenize" >::: [
  ...
  make_test_1arg
    ...
    RBrace];
  make_test_1arg
	"tokenize: weird object"
	tokenize
	"{\"primary_colors\" : 
	 [\"blu\" : [\"indigo\",\"purple\"], 	
         \"yelo\" : [\"chartreuse\",\"lime\"],
	 \"red\" : [\"pink\",\"orange\"]]}"
  [Lbrace; StringLit "primary_colors"; Colon; Lbracket; StringLit "blue"; colon; Lbracket; StringLit "indigo"; Comma; Stringlit "purple"; Rbracket; Comma; StringLit "yelo"; Colon; Lbracket: StringLit "chartreuse"; Comma; StringLit "lime"; Rbracket; Comma; StringLit "red"; Colon; StringLit "pink"; Comma; StringLit "orange"; Rbracket; Rbracket; Rbrace]
] (* add more tests *)
